...
export default function Face() {
  ...
  useEffect(() => {
    // Vérifier si l'animation est déjà terminée (au cas où)
    const isComplete = window.sessionStorage.getItem('typingAnimationComplete') === 'true';
    if (isComplete) {
      setShowFace(true);
    }
    ...
    window.addEventListener('typingAnimationComplete', handleAnimationComplete);
    
    // Nettoyage
    return () => {
      window.removeEventListener('typingAnimationComplete', handleAnimationComplete);
    };
  }, []);
    ...
    >
      <div className="h-30 overflow-hidden rounded-t-lg">
        <img
          ...
          src="/img/sydney-220003_1280.jpg"
