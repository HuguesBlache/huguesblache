...
const navigation = {
  ...
  ressources: [
    ...
    { name: "Tutorials", href: "/tutoriels" },
    { name: "Blog", href: "/blog" },
  ],
  entreprise: [
    { name: "Our Name", href: "/about#our-name" },
    { name: "Our Mission", href: "/about#our-mission" },
    { name: "Our Team", href: "/about#our-team" },
    { name: "Our Technology", href: "/about#our-technology" },
    { name: "Our Contact", href: "/about#contact" },
  ],
  legal: [
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center gap-x-2">
              <Logo className="size-61" />
              <span className="font-oswald font-bold uppercase lg:text-lg">
                Research Agent
              </span>
            </div>
            <p className="text-base text-muted-foreground">
              Analyze your documents and extract relevant information using our
              AI-based platform.
            </p>
        ...
        <div className="mt-12 border-t border-slate-700 pt-8">
          <p className="text-base text-muted-foreground xl:text-center">
            &copy; {new Date().getFullYear()} Research Agent. All rights
            reserved.
          </p>
        </div>
      </div>
